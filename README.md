...
| [Fabric_OnPrem_Kafka_Connectivity](markdown/Fabric_OnPrem_Kafka_Connectivity.md) | [PDF](pdf/Fabric_OnPrem_Kafka_Connectivity.pdf) | **Guide d'architecture Kafka on-premises vers Microsoft Fabric** (FR): cinq options comparées, injection VNet du connecteur Eventstream, Kafka Connect vers Eventhouse en HTTPS 443, custom endpoint Kafka, Azure Event Hubs intermédiaire et relais 443 vers Eventstream. Inclut flux réseau, ports, DNS, TLS, diagnostic HTTP 403 vs TCP 443, arbre de décision et plan de PoC |
