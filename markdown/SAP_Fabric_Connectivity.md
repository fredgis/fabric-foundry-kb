...
\clearpage
\methodbanner{D97706}{M1}{Fabric Data Factory extraction}
...
\clearpage
\methodbanner{2E7D32}{M2}{Mirroring through SAP Datasphere}
...
\clearpage
\methodbanner{558B2F}{M3}{Copy Job CDC through SAP Datasphere}
...
\clearpage
\methodbanner{1565C0}{M4}{Semantic federation}
...
\clearpage
\methodbanner{00796B}{M5}{SAP Datasphere governed exchange}
...
\clearpage
\methodbanner{C2410C}{M6}{Event-driven integration}
...
\clearpage
\methodbanner{4338CA}{M7}{Open Mirroring partners}
...
\clearpage
\methodbanner{AD1457}{M8}{SAP Business Data Cloud Connect}
...
## Detailed change ledger since June 2026
...
| Date | Area | Update | Guide impact and source |
| --- | --- | --- | --- |
...
| July 9 | Copy Job SCD Type 2 | Destination support expanded to Fabric and Synapse Warehouse but remained Preview. SAP Datasphere Outbound still shows no SCD Type 2 support. | Removed the SAP SCD Type 2 claim. [Source](https://learn.microsoft.com/en-us/fabric/data-factory/cdc-copy-job) |
...
| August 19 | Semantic-model lifecycle | New mirrored, Lakehouse, and Warehouse items no longer receive an automatic default semantic model. | Added explicit semantic-model creation. [Source](https://learn.microsoft.com/en-us/fabric/mirroring/get-started-with-mirroring) |
